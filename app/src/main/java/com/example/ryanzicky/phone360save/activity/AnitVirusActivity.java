...
import com.example.ryanzicky.phone360save.engine.VirusDao;
        ...
        new Thread(){
            ...
            public void run() {
                ...
                for (PackageInfo packageInfo : packageInfoList){
                    ...
                    //获取签名文件数组第一位，然后进行md5，将此md5和数据库中的md5进行比对
                    ...
                    scanInfo.name = packageInfo.applicationInfo.loadIcon(pm).toString();
                    ...
                    //8.在子线程中发送消息，告知主线程更新UI（1：顶部顶部扫描应用的名称 2：扫描过程中王线性布局）
