...
import com.example.ryanzicky.phone360save.IPackageDataObserver;
import com.example.ryanzicky.phone360save.IPackageStatsObserver;
...
public class CacheClearActivity extends Activity{
    ...
    protected void getPackageCache(final String packageName) {
            ...
            public void onGetStatsCompleted(PackageStats stats,
                ...
                if(cacheSize > 0){
                    ...
                    try {
                        ...
                        cacheInfo.name = mPm.getApplicationInfo(packageName,0).loadLabel(mPm).toString();
        ...
        try {
            ...
            //2.获取调用方法对象
            Method method = clazz.getMethod("getPackageSizeInfo", String.class,int.class,IPackageStatsObserver.class);
